"""Unified training framework for NGS model."""
import torch
...
class NGSTrainer:
    ...
    def train_epoch(
        ...
        for batch_idx, (x, y) in enumerate(pbar):
            ...
            # Handle both old and new model API
            ...
            # Topology losses
            if hasattr(self.model, 'compute_topology_losses'):
        ...
        if self.config.adapt_every_epoch:
            ...
            if hasattr(self.model, 'adapt_density'):
