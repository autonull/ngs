"""
Full 4A: Split-CIFAR100 DynamicHead - 15 epochs/task, larger model.
Validates forgetting <5%, avg acc >50% (progressive target).
"""
...
print("=" * 60)
print("FULL 4A: Split-CIFAR100, 10 tasks, 15 epochs/task")
print("=" * 60)
...
for t in range(10):
    ...
    start=time.time()
    train_task(model,tr,old,epochs=15,lr=1e-3,wd=1e-4,rb=rb,rr=1.0,kw=2.0,kt=2.0)
    for et in range(t+1):
